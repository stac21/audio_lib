...
namespace dsp {
using sample_real_t    = float;
using sample_complex_t = std::complex<float>;
...
using frame_real_t     = Frame<sample_real_t>;
using frame_complex_t  = Frame<sample_complex_t>;

constexpr sample_real_t SAMPLE_SILENCE      = 0.0f;
